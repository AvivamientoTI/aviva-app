...
import { Table, Button, Group, Modal, TextInput, NumberInput, Title, ActionIcon, Text, Alert } from '@mantine/core';
...
export function DepartmentsList() {
  ...
  const [selectedDeptForPositions, setSelectedDeptForPositions] = useState(null);
  ...
  const handleManagePositions = (dept) => {
      ...
      <Modal opened={opened} onClose={close} title={editingDept ? "Editar Departamento" : "Nuevo Departamento"}>
        <form onSubmit={handleSubmit}>
          ...
          <NumberInput
            ...
            onChange={(val) => setFormData({ ...formData, prioridad: val })}
          />
